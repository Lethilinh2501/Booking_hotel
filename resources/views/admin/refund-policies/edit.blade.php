...
<main class="lh-main-content">
    <div class="container-fluid">
        ...
        <h2 class="mb-4">Cập Nhật Chính Sách Đền Bù</h2>
                ...
                <table class="table table-bordered align-middle mb-4">
                    <tbody>
                        ...
                        <tr>
                            <th>Nội dung</th>
                            <td>
                                <textarea name="content" class="form-control" rows="3" required>{{ old('content', $policy->content) }}</textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="penalty_percent" class="form-control"
                                       value="{{ old('penalty_percent', $policy->penalty_percent) }}" min="0" max="100" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="days_before_checkin" class="form-control"
                                       value="{{ old('days_before_checkin', $policy->days_before_checkin) }}" min="0" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="is_active" class="form-select">
                                    ...
                                    <option value="0" {{ !$policy->is_active ? 'selected' : '' }}>Không hoạt động</option>
                                </select>
                            </td>
                        </tr>
                    </tbody>
