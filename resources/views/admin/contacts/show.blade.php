                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><strong>Điện thoại:</strong><br> {{ $contact->phone ?? 'Chưa cung cấp' }}</p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="mb-2">
                                                <span class="badge badge-{{
                                                    ...
                                                    {{ $contact->status == 'approved' ? 'Đã duyệt' : 
                                                      ($contact->status == 'rejected' ? 'Đã từ chối' : 'Chờ xử lý') }}
                                                </span>
                                            </div>
                                            ...
                                            <select name="status" id="status" class="form-control" required>
                                                ...
                                                <option value="approved" {{ $contact->status == 'approved' ? 'selected' : '' }}>Đã duyệt</option>
