    ...
    <main class="wrapper sb-default">
        ...
        <div class="lh-main-content">
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('admin.rooms.booked') }}" method="GET" id="filterForm"
                            ...
                            <div class="col-md-2 text-end">
                                ...
                                <a href="{{ route('admin.rooms.booked') }}" class="btn btn-secondary btn-sm mt-3 ms-2">Xóa
                                    lọc</a>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="col-12 mb-3">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="card-title">Phòng {{ $room->room_number }} (ID:
                                                {{ $room->id }})</h5>
                                        </div>
                                        <div class="card-body">
                ...
                @if (
                    $roomTypes->every(function ($roomType) {
