                                    ...
                                    <div class="guest-profile">
                                        @if ($staff->user->avatar && Storage::exists($staff->user->avatar))
                                            <img src="{{ Storage::url($staff->user->avatar) }}" alt="profile"
                                                width="150px">
                                        @else
                                            <img class="user" src="{{ asset('themes/admin/assets/img/user/thumb.jpg') }}"
                                                alt="user">
                                        @endif
                    ...
                    <div class="lh-card" id="bookingtbl">
                        ...
                        <div class="lh-card-content card-default">
                            ...
                            <div class="booking-box">
                                <h5 class="lh-card-title">Ca làm việc:</h5>
                                ...
                                <div class="booking-info">
                                    <div class="booking-details">
                                        <h5><span class="badge bg-primary">
                                                @if ($shifts)
                                                    <h5><span class="badge bg-primary">
                                                            {{ $shifts->name }} {{ $shifts->start_time }} -
                                                            {{ $shifts->end_time }}
                                                        </span></h5>
                                                @else
                                                    <h5><span class="badge bg-secondary">Chưa phân ca</span></h5>
                                                @endif
                                            </span></h5>
                                    </div>
                            ...
                            <a href="{{ route('admin.staffs.listStaff') }}" class="btn btn-secondary">Quay lại</a>
                        </div>
                    </div>
                </div>
            </div>
