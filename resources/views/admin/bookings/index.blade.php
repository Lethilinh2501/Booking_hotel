...
@section('content')
                            ...
                            <form method="GET" action="{{ route('admin.bookings.index') }}" id="filterForm">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="status" class="form-control">
                                            ...
                                            <option value="confirmed"
                                                {{ $filterData['status'] == 'confirmed' ? 'selected' : '' }}>Đã xác nhận
                                            </option>
                                            <option value="paid" {{ $filterData['status'] == 'paid' ? 'selected' : '' }}>
                                                Đã thanh toán</option>
                                            <option value="check_in"
                                                {{ $filterData['status'] == 'check_in' ? 'selected' : '' }}>Đã check in
                                            </option>
                                            <option value="check_out"
                                                {{ $filterData['status'] == 'check_out' ? 'selected' : '' }}>Đã checkout
                                            </option>
                                            <option value="cancelled"
                                                {{ $filterData['status'] == 'cancelled' ? 'selected' : '' }}>Đã hủy</option>
                                            <option value="refunded"
                                                {{ $filterData['status'] == 'refunded' ? 'selected' : '' }}>Đã hoàn tiền
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <a href="{{ route('admin.bookings.index') }}" class="btn btn-secondary">Xóa bộ
                                            lọc</a>
                                    </div>
                                </div>
                            </form>
                                        ...
                                        <tbody>
                                            @foreach ($bookings as $index => $booking)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <small> Người đặt :
                                                            {{ $booking->user->name ?? 'Không xác định' }}</small>
                                                    ...
                                                    <td>{{ \App\Helpers\FormatHelper::formatDate($booking->check_in) }}
                                                    </td>
                                                    <td>{{ \App\Helpers\FormatHelper::formatDate($booking->check_out) }}
                                                    </td>
                                                    <td>{{ \App\Helpers\FormatHelper::formatPrice($booking->total_price) }}
                                                    </td>
                                                    <td>{{ \App\Helpers\FormatHelper::formatPrice($booking->paid_amount) }}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('admin.bookings.update', $booking->id) }}"
                                                            ...
                                                            id="statusForm-{{ $booking->id }}">
                                                            @csrf
                                                            @method('PUT')
                                                            <input type="hidden" name="_token"
                                                                value="{{ csrf_token() }}">
                                                            <select name="status" class="form-select"
                                                                onchange="handleStatusChange(this, '{{ $booking->id }}', {{ $booking->total_guests }})">
                                                                @php
                                                                    $allowedTransitions = [
                                                                        'unpaid' => ['cancelled'],
                                                                ...
                                                                <option value="unpaid"
                                                                    {{ $booking->status == 'unpaid' ? 'selected' : '' }}
                                                                    {{ !in_array('unpaid', $allowedStatuses) && $booking->status != 'unpaid' ? 'disabled' : '' }}>
                                                                    {{ \App\Helpers\BookingStatusHelper::getStatusLabel('unpaid') }}
                                                                </option>
                                                                <option value="partial"
                                                                    {{ $booking->status == 'partial' ? 'selected' : '' }}
                                                                    {{ !in_array('partial', $allowedStatuses) && $booking->status != 'partial' ? 'disabled' : '' }}>
                                                                    {{ \App\Helpers\BookingStatusHelper::getStatusLabel('partial') }}
                                                                </option>
                                                                <option value="paid"
                                                                    {{ $booking->status == 'paid' ? 'selected' : '' }}
                                                                    {{ !in_array('paid', $allowedStatuses) && $booking->status != 'paid' ? 'disabled' : '' }}>
                                                                    {{ \App\Helpers\BookingStatusHelper::getStatusLabel('paid') }}
                                                                </option>
                                                                <option value="check_in"
                                                                    {{ $booking->status == 'check_in' ? 'selected' : '' }}
                                                                    {{ !in_array('check_in', $allowedStatuses) && $booking->status != 'check_in' ? 'disabled' : '' }}>
                                                                    {{ \App\Helpers\BookingStatusHelper::getStatusLabel('check_in') }}
                                                                </option>
                                                                <option value="check_out"
                                                                    {{ $booking->status == 'check_out' ? 'selected' : '' }}
                                                                    {{ !in_array('check_out', $allowedStatuses) && $booking->status != 'check_out' ? 'disabled' : '' }}>
                                                                    {{ \App\Helpers\BookingStatusHelper::getStatusLabel('check_out') }}
                                                                </option>
                                                                <option value="cancelled"
                                                                    {{ $booking->status == 'cancelled' ? 'selected' : '' }}
                                                                    {{ !in_array('cancelled', $allowedStatuses) && $booking->status != 'cancelled' ? 'disabled' : '' }}>
                                                                    {{ \App\Helpers\BookingStatusHelper::getStatusLabel('cancelled') }}
                                                                </option>
                                                                <option value="cancelled_without_refund"
                                                                    {{ $booking->status == 'cancelled_without_refund' ? 'selected' : '' }}
                                                                    {{ !in_array('cancelled_without_refund', $allowedStatuses) && $booking->status != 'cancelled_without_refund' ? 'disabled' : '' }}>
                                                                    {{ \App\Helpers\BookingStatusHelper::getStatusLabel('cancelled_without_refund') }}
                                                                </option>
                                                                <option value="refunded"
                                                                    {{ $booking->status == 'refunded' ? 'selected' : '' }}
                                                                    {{ !in_array('refunded', $allowedStatuses) && $booking->status != 'refunded' ? 'disabled' : '' }}>
    ...
    <div class="modal fade" id="checkInModal" tabindex="-1" aria-labelledby="checkInModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="checkInForm" method="POST" action="{{ route('admin.bookings.checkin.store') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-danger" id="guestError" style="display:none;">Bạn đã nhập đủ số lượng người ở
                            tối đa.</div>
                    </div>
    ...
    <div class="modal fade" id="processRefundRequestModal" tabindex="-1"
        aria-labelledby="processRefundRequestModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <form id="processRefundForm" method="POST">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" name="action" value="approve" class="btn btn-success">Phê
                                duyệt</button>
                        </div>
                    </form>
                </div>
        ...
        function handleStatusChange(selectElement, bookingId, maxGuests) {
            ...
            if (selectedStatus === 'check_in') {
                            ...
                            if (!response.ok) {
                                return response.text().then(text => {
                                    ...
                                    try {
                                        ...
                                        displayGeneralError(
                                            'Lỗi hệ thống: Không thể xử lý phản hồi từ server.');
                                    }
                ...
                fetch(`/admin/bookings/${bookingId}/get-remaining-amount`, {
                    ...
                    .then(data => {
                        document.getElementById('remaining_amount').value = data.remaining_amount.toLocaleString(
                            'vi-VN') + ' VNĐ';
                        modal.show();
                    })
                    .catch(error => {
                ...
                `;
                        document.querySelector('.lh-card-content').insertBefore(alertDiv, document.querySelector(
                            '.booking-table'));
                    });
            } else {
                form.submit();
                ...
                modal.addEventListener('show.bs.modal', function(event) {
                    ...
                    fetch(`/admin/refunds/${refundId}/details`)
                        ...
                        .then(data => {
                            ...
                            document.getElementById('modalBookingCode').textContent = data.booking
                                .booking_code;
                            document.getElementById('modalCustomerName').textContent = data.booking.user
                                .name;
                            document.getElementById('modalCheckIn').textContent = data.booking.check_in;
                            document.getElementById('modalCheckOut').textContent = data.booking
                                .check_out;
                            document.getElementById('modalTotalAmount').textContent = formatCurrency(
                                data.booking.total_price);
                            document.getElementById('modalRefundPolicy').textContent = data
                                .refund_policy.name;
                            document.getElementById('modalPaidAmount').textContent = formatCurrency(data
                                .booking.paid_amount);
                            document.getElementById('modalRefundAmount').textContent = formatCurrency(
                                data.amount);
                            document.getElementById('modalCancellationFee').textContent =
                                formatCurrency(data.cancellation_fee);
                            document.getElementById('modalRefundReason').textContent = data.reason;

                            // Set form action
                            document.getElementById('processRefundForm').action =
