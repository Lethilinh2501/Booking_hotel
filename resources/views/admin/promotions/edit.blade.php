                ...
                <form action="{{ route('admin.promotions.update', $promotion->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="type" id="type" class="form-select">
                            <option value="percent" {{ old('type', $promotion->type) == 'percent' ? 'selected' : '' }}>Phần
                                trăm</option>
                            <option value="fixed" {{ old('type', $promotion->type) == 'fixed' ? 'selected' : '' }}>Giá cố
                                định</option>
                        </select>
                        @error('type')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" id="status" class="form-select">
                            ...
                            <option value="inactive"
                                {{ old('status', $promotion->status) == 'inactive' ? 'selected' : '' }}>Ngưng hoạt động
                            </option>
                        </select>
                        @error('status')
                            <div class="text-danger">{{ $message }}</div>
