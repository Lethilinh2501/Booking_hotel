            ...
            <div class="col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5">
                <div class="card border border-light-subtle rounded-4">
                    <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <div class="col-12">
                                <div class="mb-4">
                                    <div class="text-center mb-4">
                                        <a href="/">
                                            <img src="{{ asset('themes/client/assets/img/logo/logo_about.png') }}"
                                                alt="Logo" width="280">
                                        </a>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="password" class="form-control" name="password_confirmation"
                                            id="password-confirm" placeholder="Xác nhận mật khẩu" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                    <a href="{{ route('login') }}" class="link-secondary text-decoration-none">Đăng
                                        nhập</a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p class="mt-3 mb-4">Hoặc tiếp tục với</p>
