...
<body data-lh-mode="light">
    <main class="wrapper sb-default">
        ...
        <!-- Notify sidebar -->
        {{-- @include('admin.blocks.notify-sidebar') --}}
                ...
                <div class="lh-tools-block">
                    ...
                    <div class="lh-tools-info">
                        <div class="lh-tools-item mode active" data-lh-mode-tool="light">
                            <img src="{{ asset('themes/admin/assets/img/tools/light.png') }}" alt="light">
                            <p>light</p>
                        </div>
                        <div class="lh-tools-item mode" data-lh-mode-tool="dark">
                            <img src="{{ asset('themes/admin/assets/img/tools/dark.png') }}" alt="dark">
                            <p>dark</p>
                        </div>
                    </div>
                </div>
                <div class="lh-tools-block">
                    ...
                    <div class="lh-tools-info">
                        <div class="lh-tools-item sidebar active" data-sidebar-mode-tool="light">
                            <img src="{{ asset('themes/admin/assets/img/tools/side-light.png') }}" alt="light">
                            <p>light</p>
                        </div>
                        <div class="lh-tools-item sidebar" data-sidebar-mode-tool="dark">
                            <img src="{{ asset('themes/admin/assets/img/tools/side-dark.png') }}" alt="dark">
                            <p>dark</p>
                        </div>
                        <div class="lh-tools-item sidebar" data-sidebar-mode-tool="bg-1">
                            <img src="{{ asset('themes/admin/assets/img/tools/side-bg-1.png') }}" alt="background">
                            <p>Bg-1</p>
                        </div>
                        <div class="lh-tools-item sidebar" data-sidebar-mode-tool="bg-2">
                            <img src="{{ asset('themes/admin/assets/img/tools/side-bg-2.png') }}" alt="background">
                            <p>Bg-2</p>
                        </div>
                        <div class="lh-tools-item sidebar" data-sidebar-mode-tool="bg-3">
                            <img src="{{ asset('themes/admin/assets/img/tools/side-bg-3.png') }}" alt="background">
                            <p>Bg-3</p>
                        </div>
                        <div class="lh-tools-item sidebar" data-sidebar-mode-tool="bg-4">
                            <img src="{{ asset('themes/admin/assets/img/tools/side-bg-4.png') }}" alt="background">
                            <p>Bg-4</p>
                        </div>
                    </div>
                </div>
                <div class="lh-tools-block">
                    ...
                    <div class="lh-tools-info">
                        <div class="lh-tools-item header active" data-header-mode="light">
                            <img src="{{ asset('themes/admin/assets/img/tools/header-light.png') }}" alt="light">
                            <p>light</p>
                        </div>
                        <div class="lh-tools-item header" data-header-mode="dark">
                            <img src="{{ asset('themes/admin/assets/img/tools/header-dark.png') }}" alt="dark">
                            <p>dark</p>
                        </div>
                    </div>
                </div>
                <div class="lh-tools-block">
                    ...
                    <div class="lh-tools-info">
                        <div class="lh-tools-item bg active" data-bg-mode="default">
                            <img src="{{ asset('themes/admin/assets/img/tools/bg-0.png') }}" alt="default">
                            <p>Default</p>
                        </div>
                        <div class="lh-tools-item bg" data-bg-mode="bg-1">
                            <img src="{{ asset('themes/admin/assets/img/tools/bg-1.png') }}" alt="bg-1">
                            <p>Bg-1</p>
                        </div>
                        <div class="lh-tools-item bg" data-bg-mode="bg-2">
                            <img src="{{ asset('themes/admin/assets/img/tools/bg-2.png') }}" alt="bg-2">
                            <p>Bg-2</p>
                        </div>
                        <div class="lh-tools-item bg" data-bg-mode="bg-3">
                            <img src="{{ asset('themes/admin/assets/img/tools/bg-3.png') }}" alt="bg-3">
                            <p>Bg-3</p>
                        </div>
                        <div class="lh-tools-item bg" data-bg-mode="bg-4">
                            <img src="{{ asset('themes/admin/assets/img/tools/bg-4.png') }}" alt="bg-4">
                            <p>Bg-4</p>
                        </div>
                        <div class="lh-tools-item bg" data-bg-mode="bg-5">
                            <img src="{{ asset('themes/admin/assets/img/tools/bg-5.png') }}" alt="bg-5">
                            <p>Bg-5</p>
                        </div>
                    </div>
                </div>
                <div class="lh-tools-block">
                    ...
                    <div class="lh-tools-info">
                        <div class="lh-tools-item box active" data-box-mode-tool="default">
                            <img src="{{ asset('themes/admin/assets/img/tools/box-0.png') }}" alt="default">
                            <p>Default</p>
                        </div>
                        <div class="lh-tools-item box" data-box-mode-tool="box-1">
                            <img src="{{ asset('themes/admin/assets/img/tools/box-1.png') }}" alt="box-1">
                            <p>Box-1</p>
                        </div>
                        <div class="lh-tools-item box" data-box-mode-tool="box-2">
                            <img src="{{ asset('themes/admin/assets/img/tools/box-2.png') }}" alt="box-2">
                            <p>Box-2</p>
                        </div>
                        <div class="lh-tools-item box" data-box-mode-tool="box-3">
                            <img src="{{ asset('themes/admin/assets/img/tools/box-3.png') }}" alt="box-3">
                            <p>Box-3</p>
                        </div>
                    </div>
                </div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <script src="{{ asset('themes/admin/assets/js/myjs.js') }}"></script>
