                             ...
                             <form method="POST" action="{{route('contacts.store')}}">    
                               @csrf                
                                <div class="lh-contact-touch-inner-form-warp">
                                    <input type="number" id="contact_phone" name="phone" placeholder="Phone*"
                                        class="lh-form-control mr-30" required="">
                                    <input type="email" id="contact_email" name="email" placeholder="Email*" class="lh-form-control"
                                        required="">
                                </div>
                                <div class="lh-contact-touch-inner-form-warp">
                                       <input type="text" id="contact_title" name="title" placeholder="title*"
