<section class="section-blog bg-gray padding-tb-100">
    <div class="container">
        ...
        <div class="slick-slider blog-slider" data-aos="fade-up" data-aos-duration="2000">
            <div class="blog-card">
                <figure><img src="{{ asset('themes/client/assets/img/blog/2.jpg ') }}" alt="blog-img"
                        class="blog-image-top"></figure>
                <div class="lh-blog">
            ...
            <div class="blog-card">
                <figure><img src="{{ asset('themes/client/assets/img/blog/3.jpg ') }}" alt="blog-img"
                        class="blog-image-top"></figure>
                <div class="lh-blog">
                    <div class="lh-blog-date">
            ...
            <div class="blog-card">
                <figure><img src="{{ asset('themes/client/assets/img/blog/4.jpg ') }}" alt="blog-img"
                        class="blog-image-top"></figure>
                <div class="lh-blog">
                    <div class="lh-blog-date">
            ...
            <div class="blog-card">
                <figure><img src="{{ asset('themes/client/assets/img/blog/5.jpg ') }}" alt="blog-img"
                        class="blog-image-top"></figure>
                <div class="lh-blog">
                    <div class="lh-blog-date">
            ...
            <div class="blog-card">
                <figure><img src="{{ asset('themes/client/assets/img/blog/6.jpg ') }}" alt="blog-img"
                        class="blog-image-top"></figure>
                <div class="lh-blog">
                    <div class="lh-blog-date">
