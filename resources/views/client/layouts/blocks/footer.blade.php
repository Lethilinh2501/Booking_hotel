            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 rs-pb-24 p-991 order-lg-1 order-md-2 order-2">
                    <div class="lh-footer-cols-contain">
                        ...
                        <ul>
                            <li><code>*</code> <a href="{{ url('/') }}">Home</a></li>
                            <li><code>*</code> <a href="{{ url('/about') }}">About</a></li>
                            <li><code>*</code> <a href="{{ url('/room-details') }}">Rooms & suites</a></li>
                            <li><code>*</code> <a href="{{ url('/spa') }}">Spa & Wellness</a></li>
                            <li><code>*</code> <a href="{{ url('/restaurant') }}">Restaurant</a></li>
                            <li><code>*</code> <a href="{{ url('/gallery') }}">Gallery</a></li>
                            <li><code>*</code> <a href="{{ url('/contact') }}">Contact</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="lh-social-media">
                        ...
                        <div class="lh-follow-social">
                            ...
                            <div class="footer-logo-image">
                                <a href="#"><img src="{{ asset('themes/client/assets/img/logo/facebook.png') }}"
                                        alt="facebook"></a>
                                <a href="#"><img src="{{ asset('themes/client/assets/img/logo/twitter.png') }}"
                                        alt="twitter"></a>
                                <a href="#"><img src="{{ asset('themes/client/assets/img/logo/instagram.png') }}"
                                        alt="instagram"></a>
                                <a href="#"><img src="{{ asset('themes/client/assets/img/logo/linkedin.png') }}"
                                        alt="linkedin"></a>
                                <a href="#"><img src="{{ asset('themes/client/assets/img/logo/dribbble.png') }}"
                                        alt="dribbble"></a>
                                <a href="#"><img src="{{ asset('themes/client/assets/img/logo/pinterest.png') }}"
                                        alt="pinterest"></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="lh-footer-contact-infoemation">
                            <ul>
                                <li class="lh-information">
                                    ...
                                    <span>5 Green st. Huntington Station, NY 11746, Libero voluptatem soluta
                                        Bharat.</span>
                                </li>
                                <li class="lh-information">
