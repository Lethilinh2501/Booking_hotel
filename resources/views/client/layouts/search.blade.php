<section class="section-search-control">
    <div class="container">
        <form action="{{ route('client.home') }}" method="GET" id="search-form">
                    ...
                    <div class="search-box">
                        ...
                        <div class="calendar">
                            ...
                            <input type="hidden" name="check_in" id="check_in"
                                value="{{ $checkIn ?? date('Y-m-d H:i:s', strtotime('today 14:00')) }}">
                            <input type="hidden" name="check_out" id="check_out"
                                value="{{ $checkOut ?? date('Y-m-d H:i:s', strtotime('tomorrow 12:00')) }}">
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Gọi updateButtonStates ban đầu
        updateButtonStates();
