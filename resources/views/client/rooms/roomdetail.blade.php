                            ...
                            <form action="{{ route('bookings.create') }}" method="GET" id="booking-form">
                                        ...
                                        @if ($service->is_active)
                                            <div class="service-item d-flex align-items-center mb-2">
                                                <div class="service-name flex-grow-1">
                                                    {{ $service->name }} ({{ $service->price == 0 ? 'Miễn phí' : ($service->price) }})
                                                </div>
                                ...
                                <div class="lh-side-reservation-from">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <p><span id="base-price-display">{{ ($basePrice) }}</span></p>
                                    </div>
                                    @if ($discountedPrice < $basePrice && $roomType->promotion_info)
                                        <div class="d-flex justify-content-between gap-2">
                                            ...
                                            <p>-<span id="discount-amount-display">{{ ($discountAmount) }}</span></p>
                                        </div>
                                    @endif
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p>Thuế và phí (8%)</p>
                                        <p><span id="tax-fee-display">{{ ($taxFee) }}</span></p>
                                    </div>
                                    <hr>
                                    <div class="d-flex justify-content-between">
                                        <h4>Tổng cộng</h4>
                                        <h5 class="text-danger" id="total-price-display">{{ ($totalPrice) }}</h5>
                                    </div>
