                            ...
                            <div class="d-flex border rounded overflow-hidden shadow-sm h-100 p-3">
                                ...
                                <div class="me-3 d-flex flex-column align-items-center justify-content-center"
                                    ...
                                    <img src="https://cdn-icons-png.flaticon.com/512/888/888879.png" alt="coupon"
                                        class="img-fluid mb-2" style="width:70px;">
                                    <div class="small text-muted">Hạn: {{ date('d-m-Y', strtotime($promotion->end_date)) }}
                                    </div>
                                </div>
                                ...
                                <div class="flex-grow-1 d-flex flex-column justify-content-between">
                                    <div>
                                        ...
                                        <p class="mb-1 text-muted">Áp dụng từ
                                            {{ date('d/m/Y', strtotime($promotion->start_date)) }} đến
                                            {{ date('d/m/Y', strtotime($promotion->end_date)) }}</p>
                                        <p class="mb-1">Giảm tối đa: {{ number_format($promotion->max_discount_value) }}đ
                                        </p>
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-warning fw-bold w-100 mb-2 copy-code-btn"
                                            data-code="{{ $promotion->code }}">
                                            {{ $promotion->code }}
                                        </button>

                                        <p class="small text-muted mb-0">
                                            * Áp dụng cho đơn từ <span
                                                class="fw-bold">{{ number_format($promotion->min_booking_amount) }}đ</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
