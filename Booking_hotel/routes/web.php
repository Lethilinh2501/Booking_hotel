...
Route::prefix('admin')->as('admin.')->group(function () {
    ...
    // Category routes (comment sẵn, mở khi cần)
    /*
...
Route::prefix('policies')->as('policies.')->group(function () {
    ...
    Route::put('/update/{id}', [PolicyController::class, 'update'])->name('update');
    Route::delete('/destroy/{id}', [PolicyController::class, 'destroy'])->name('destroy');
});
// Rule routes (Nội quy - Quy định)
Route::prefix('rules')->as('rules.')->group(function () {
    ...
    Route::delete('/destroy/{id}', [RuleController::class, 'destroy'])->name('destroy');
});
