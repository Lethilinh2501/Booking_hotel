...
class RoomController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.rooms.index', compact('roomTypes', 'title', 'allRoomTypes', 'allAmenities', 'checkIn', 'checkOut', 'dateRange', 'totalGuests', 'childrenCount', 'roomCount', 'minPrice', 'maxPrice', 'amenities'));
    }
    ...
    public function bookedRooms(Request $request)
    {
        ...
        return view('admin.rooms.booked', compact('roomTypes', 'title', 'allRoomTypes', 'checkIn', 'checkOut'));
    }
